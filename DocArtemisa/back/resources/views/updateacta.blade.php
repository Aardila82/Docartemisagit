...
@endif
    ...
    <div class="col-12">
        <div>
            <h2>Actaulizar Acta {{$acta->title}}</h2>
        </div>
        <div>
    ...
    <form action="{{route('acta.update',$acta)}}" method="POST">
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 mt-2">
                <div class="form-group">
                    <strong>Acta:</strong>
                    <input type="text" name="title" class="form-control" placeholder="N&uacute;mero acta" value="{{$acta->title}}">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12 mt-2">
                <div class="form-group">
